              ...
              <div class="box-body">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nip" value="{{old('nip')}}" placeholder="Enter nip">
                        @error('nip')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="tempat_lahir" value="{{old('tempat_lahir')}}" placeholder="Enter tempat lahir">
                        @error('tempat_lahir')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="tanggal_lahir" value="{{old('tanggal_lahir')}}" placeholder="Enter tanggal_lahir">
                        @error('tanggal_lahir')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="pendidikan" value="{{old('pendidikan')}}" placeholder="Enter pendidikan">
                        @error('pendidikan')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="jabatan" value="{{old('jabatan')}}" placeholder="Enter jabatan">
                        @error('jabatan')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
