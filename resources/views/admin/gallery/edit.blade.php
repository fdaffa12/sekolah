              ...
              <div class="box-body">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title" value="{{$data->title}}" placeholder="Enter Judul">
                        @error('title')
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="body" cols="20" rows="5" class="form-control">{{$data->description}}</textarea>
                        @error('description')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
