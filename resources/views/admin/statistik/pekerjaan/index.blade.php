        ...
        <div class="col-xs-9">
          <div class="box">
            <div class="box-header">
                <h3 class="box-title">Manage Statistik Pekerjaan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                  @if( $data->status == 0 )
                  <a href="{{ url('admin/publish-pekerjaan/'.$data->id) }}" class="btn btn-xs btn-primary">Publish</a>
                  @else
                  <label class="label label-info">Sudah Dipublish</label> 
                  <a href="{{ url('admin/draft-pekerjaan/'.$data->id) }}" class="btn btn-xs btn-danger"> Draft</a>
                  @endif
                  </td>
                  <td>
                    <div style="width:60px">
                        <a href="{{url('admin/edit-pekerjaan/'.$data->id)}}" class="btn btn-warning btn-xs btn-edit" id="edit"><i class="fa fa-pencil-square-o"></i></a>
                        <a href="{{url('admin/delete-pekerjaan/'.$data->id)}}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-xs btn-info" id="detail"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                @endforeach
        ...
        <div class="col-md-3">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Statistik Pekerjaan</h3>
                </div>
            <!-- form start -->
