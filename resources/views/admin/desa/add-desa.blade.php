    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
            ...
            <!-- form start -->
            <form action="{{route('store.desa')}}" method="POST" enctype="multipart/form-data">
			@csrf
              <div class="box-body">
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="form-control-label">Nama Desa: <span class="tx-danger">*</span></label>
                        <input class="form-control" type="text" name="nama_desa" value="{{old('nama_desa')}}" placeholder="Enter Judul">
                        @error('nama_desa')
